        ...
        <AccordionPrimitive.Trigger {...props} asChild>
          <Trigger
            className={cn(
              ...
              Platform.select({
                web: 'focus-visible:border-neutral-950 focus-visible:ring-neutral-950/50 flex flex-1 outline-none transition-all hover:underline focus-visible:ring-[3px] disabled:pointer-events-none [&[data-state=open]>svg]:rotate-180 dark:focus-visible:border-neutral-300 dark:focus-visible:ring-neutral-300/50',
              }),
              className
            )}>
            <>{children}</>
            <Animated.View style={chevronStyle}>
              <Icon
                ...
                size={16}
                className={cn(
                  'text-neutral-500 shrink-0 dark:text-neutral-400',
                  Platform.select({
