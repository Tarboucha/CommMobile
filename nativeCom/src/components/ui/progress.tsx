...
function WebIndicator({ value, className }: IndicatorProps) {
  ...
  return (
    <View
      className={cn('bg-neutral-900 h-full w-full flex-1 transition-all dark:bg-neutral-50', className)}
...
function NativeIndicator({ value, className }: IndicatorProps) {
  ...
  return (
    <ProgressPrimitive.Indicator asChild>
      <Animated.View style={indicator} className={cn('bg-neutral-950 h-full dark:bg-neutral-50', className)} />
