    ...
    <AlertDialogPortal hostName={portalHost}>
      <AlertDialogOverlay>
        <AlertDialogPrimitive.Content
          className={cn(
            'bg-white border-neutral-200 z-50 flex w-full max-w-[calc(100%-2rem)] flex-col gap-4 rounded-lg border p-6 shadow-lg shadow-black/5 sm:max-w-lg dark:bg-neutral-950 dark:border-neutral-800',
            Platform.select({
...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      className={cn('text-neutral-950 text-lg font-semibold dark:text-neutral-50', className)}
      {...props}
    />
  );
}
