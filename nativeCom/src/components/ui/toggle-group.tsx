...
function useToggleGroupContext() {
  ...
  if (context === null) {
    throw new Error(
      'ToggleGroup compound components cannot be rendered outside the component'
    );
  }
  return context;
}
    ...
    <TextClassContext.Provider
      ...
      <ToggleGroupPrimitive.Item
        className={cn(
          ...
          ToggleGroupPrimitive.utils.getIsSelected(value, props.value) && 'bg-neutral-100 dark:bg-neutral-800',
